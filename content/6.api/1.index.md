...
| **MCP server** | `jscpd --mcp <path>` | AI assistants (Claude, Cursor, Copilot) checking code as you write it |
...
The binary serves the Model Context Protocol over stdio with `jscpd --mcp <path>`, so AI assistants can check snippets and files against your project. See [MCP Server](/api/mcp-server).
