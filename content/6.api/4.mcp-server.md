...
seo:
  ...
  description: Integrate jscpd with AI assistants via Model Context Protocol (MCP) using the built-in `jscpd --mcp` stdio server.
---
...
1. Start the server (`jscpd --mcp <path>`) — it scans and indexes the codebase
