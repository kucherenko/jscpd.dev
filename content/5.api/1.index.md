...
> Need a JavaScript/TypeScript API (`import { jscpd } from 'jscpd'`)? It is available in v4 on the [`master-v4` branch](https://github.com/kucherenko/jscpd/tree/master-v4) — see the [Migration Guide](/getting-started/migration).
