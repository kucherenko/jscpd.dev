...
> Looking for the Node.js HTTP server (`jscpd-server`, REST API + MCP over HTTP)? It belongs to v4 and is documented on the [`master-v4` branch](https://github.com/kucherenko/jscpd/tree/master-v4).
