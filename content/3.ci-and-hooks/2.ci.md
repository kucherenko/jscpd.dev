...
| `history` | Duplication trend over git history: scan every commit in this range (e.g. `v5.0.0..HEAD`) and print a chart and table in the log; needs `fetch-depth: 0` (5.2.1+) | — |
