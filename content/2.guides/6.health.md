...
::note
Available from jscpd **5.3.0**. Dead code is measured for JavaScript, TypeScript and Python, including Vue, Svelte and Astro components. This page describes the formula as of **5.3.1**.
::
...
All weights are 1 unless you change them, with one exception. Dead code weighs as much as the share of the code it could read: in a project that is 30% TypeScript and 70% Rust, the dead-code sub-score gets a weight of 0.3. When JavaScript, TypeScript and Python are under 5% of the code, dead code is skipped and the report says so.
