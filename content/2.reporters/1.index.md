...
| `html` | Interactive HTML report (`html/` folder) |
...
> Note: A reporter can be developed manually, see [@jscpd/finder](https://github.com/kucherenko/jscpd/tree/master/apps/finder) package.
