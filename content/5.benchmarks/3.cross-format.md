...
- **All jscpd variants** parse `.vue`, `.svelte`, `.astro`, and `.md` into separate language sections, detecting cross-format clones with language attribution. jscpd@5 is the most conservative, finding 2 cross-format clones (53 lines); jscpd-rs finds 4 (235 lines).
