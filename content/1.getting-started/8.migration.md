...
The v4 (TypeScript) source and documentation live on the [`master-v4` branch](https://github.com/kucherenko/jscpd/tree/master-v4) of the jscpd repository; this site documents v5 only.
...
v4 is still published on npm under the `latest-4` dist-tag and maintained on the [`master-v4` branch](https://github.com/kucherenko/jscpd/tree/master-v4), with its own README and package docs. If you depend on the Node.js API, the `jscpd-server` package, or the LevelDB/Redis store, you can keep using it:
