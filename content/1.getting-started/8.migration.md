...
- **MCP**: Use [`cpd --mcp`](/api/mcp-server) to expose detection to AI assistants
...
| `jscpd-server` | Built-in MCP server: `cpd --mcp` (the Node.js server remains on [`master-v4`](https://github.com/kucherenko/jscpd/tree/master-v4)) |
