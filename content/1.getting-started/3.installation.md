...
Installs both the `jscpd` and `cpd` commands. For a Node-free [pre-commit](https://pre-commit.com) hook, use `language: python` with `additional_dependencies: ['jscpd==5.2.1']`.
