...
::note
**Looking for v4?** The TypeScript version is maintained on the [`master-v4` branch](https://github.com/kucherenko/jscpd/tree/master-v4) and installs with `npm install -g jscpd@4`. See the [Migration Guide](/getting-started/migration) for what changed.
::
