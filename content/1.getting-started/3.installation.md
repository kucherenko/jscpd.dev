...
By default the shell installer puts `cpd` (and the `jscpd` alias) in `~/.local/bin`, and prints the command to add that directory to your PATH. Install to a custom directory:
