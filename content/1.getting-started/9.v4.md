---
title: jscpd v4 (TypeScript)
description: The Node.js version of jscpd — where it lives, when to use it, and how to install and run it.
navigation:
  icon: i-simple-icons-typescript
seo:
  title: jscpd v4 (TypeScript engine)
  description: jscpd v4 is the TypeScript version of the copy/paste detector, maintained on the master-v4 branch and published as jscpd@4. Install, CLI, config, reporters, Node.js API, and packages.
---

jscpd v4 is the version of the copy/paste detector written in TypeScript and running on Node.js. It is maintained on the [`master-v4` branch](https://github.com/kucherenko/jscpd/tree/master-v4) and published to npm under the `latest-4` dist-tag. The current major version, v5, is a Rust engine that ships as a self-contained binary and is what this site documents everywhere else.
...
If none of these apply, use v5. The [migration guide](/getting-started/migration) lists every flag and config difference.
