...
See the [Changelog](/getting-started/changelog) for the full release history. Coming from the TypeScript version? See the [Migration Guide](/getting-started/migration) — the v4 documentation lives on the [`master-v4` branch](https://github.com/kucherenko/jscpd/tree/master-v4).
